...
namespace lazperf
{
    namespace reader
    {
        ...
        struct basic_file::Private
        {
            ...
            laz_vlr laz;
            eb_vlr eb;
            copc_info_vlr copcInfoVlr;
            // copc_hierarchy_vlr copcHierarchyVlr;
            chunk *current_chunk;
                                             ...
                                             uint64_t data_length)
        {
            ...
            // Extract COPC INFO VLR
            else if (user_id == "copc" && record_id == 1)
            {
                copcInfoVlr.read(*f);
                return true;
            }
            // Extract COPC HIERARCHY VLR
            // else if (user_id == "copc" && record_id == 1000)
            // {
            //     copcHierarchyVlr.read(*f);
            //     return true;
            // }
            return false;
        }
...
#pragma pack(pop)
        ...
        copc_info_vlr basic_file::copcInfoVlr() const
        {
            return p_->copcInfoVlr;
        }
        ...
        chunk_decompressor::chunk_decompressor(int format, int ebCount, const char *srcbuf) : p_(new Private)
        {
